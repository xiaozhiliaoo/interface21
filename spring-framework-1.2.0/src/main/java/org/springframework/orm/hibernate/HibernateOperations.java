...
public interface HibernateOperations {
	 ...
	 * @param lockMode the lock mode to obtain
	 * @throws DataAccessException in case of Hibernate errors
	 * @see net.sf.hibernate.Session#refresh(Object, LockMode)
	 */
	 ...
	 * @return a List containing 0 or more persistent instances
	 * @throws DataAccessException in case of Hibernate errors
	 * @see net.sf.hibernate.Session#find(String, Object, Type)
	 * @see net.sf.hibernate.Session#createQuery
	 */
	 ...
	 * @return a List containing 0 or more persistent instances
	 * @throws DataAccessException in case of Hibernate errors
	 * @see net.sf.hibernate.Session#iterate(String, Object, Type)
	 * @see net.sf.hibernate.Session#createQuery
	 */
	 ...
	 * @return the number of instances deleted
	 * @throws DataAccessException in case of Hibernate errors
	 * @see net.sf.hibernate.Session#delete(String, Object, Type)
	 */
